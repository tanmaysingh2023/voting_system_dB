...
const LandingPage = () => {
  return (
    <div className="bg-gray-900 text-white min-h-screen flex flex-col gap-10 items-center justify-center px-6">
      ...
      <main className="w-full flex items-center justify-center px-14">
